...
<head>
    ...
    <link href="assets/plugins/bootstrap-responsive/bootstrap-responsive.css" rel="stylesheet" />
...
<header class="jumbotron subhead">
    <div class="container container-narrow">
        ...
        <p class="lead">Documentation For Metronic Version 4.1.0</p>
    </div>
</header>
<div class="container">
    <div class="row">
                ...
                <tr>
                    ...
                    <td width="50%">
                        ...
                        <ul class="menu">
                            ...
                            <li><a href="javascript:;" class="clickable" data-section="#sass">9. SASS Support</a></li>
                            <li><a href="javascript:;" class="clickable" data-section="#init">10. Folder Structure</a></li>
        ...
        <div class="span12">
            <section id="theme_config">
                ...
                <p>
                    ...
                    To setup a selected theme. Include <code>../../assets/admin/layout/css/themes/[theme_name].css</code> in page head.
                    For instance, if you like to use blue theme, include <code>../../assets/admin/layout/css/themes/darkblue.css</code> css file. CSS file load order should be followed as shown below:
                </p>
                        <pre class="prettyprint linenums">
&lt;link href=&quot;../../assets/admin/layout/css/themes/default.css&quot; rel=&quot;stylesheet&quot; type=&quot;text/css&quot; id=&quot;style_color&quot;/&gt;
</pre>
    ...
    <div class="row">
        <div class="span12">
            <section id="top_menu">
                ...
                <img src="assets/img/top_menu_1.png" class="img-polaroid">
                <img src="assets/img/top_menu_2.jpg" class="img-polaroid">
                </i>
    ...
    <div class="row">
        <div class="span12">
            <section id="sidebar_menu">
                ...
                <img src="assets/img/main_menu.jpg" class="img-polaroid">
                </i>
    ...
    <div class="row">
        <div class="span12">
            <section id="hor_menu">
                ...
                <img src="assets/img/hor_menu.jpg" class="img-polaroid">
                </i>
...
&lt;!-- END HORIZANTAL MENU --&gt;
    ...
    <div class="row">
        <div class="span12">
            <section id="sass">
                <div class="page-header">
                    <h1>9. SASS Support</h1>
                    <a href="javascript:;">To top <i class="icon-arrow-up"></i></a>
                </div>
                <p>
                    Metronic Admin Themes CSS is powered by SASS(<a href="sass-lang.com" target="_black">sass-lang.com</a>). Required SASS versions is v3.3.7 or later. We recommend you to use Koala App Tool from <a href="koala-app.com" target="_black">koala-app.com</a> to compile realtime the SASS files. So just install the Koala App Tool and add the Metronic SASS directory(theme/sass) to start compiling the SASS files.
                </p>
                <p>
                    When you compile the sass files do not compile includable sass files that their filename starts with underscore(e.g: _variables.scss, _buttons.scss). Only the master files can be compiled(all the scss files without underscore infront of their filenames).
                    Refer the below master SASS files to be compiled to spesific paths. For more info please check sass/koala-config.json file which used as a main configuration file to comple the Metronic sass files.
                </p>
            </section>
        </div>
    </div>
        ...
        <div class="span12">
            <section id="init">
                ...
                <table class="table table-bordered table-striped1" width="600">
                    ...
                    <tr>
                        <td style="padding-left: 25px"><code><i class="icon icon-minus"></i>assets</code></td>
                        <td>Assets folder contains of compiled css files, plugins, images and other files used by the theme</td>
                    </tr>
                    <tr>
                        <td style="padding-left: 50px"><code><i class="icon icon-minus"></i>admin</code></td>
                        <td>Contains of the admin theme's css, javascript and image files</td>
                    </tr>
                    <tr>
                        <td style="padding-left: 50px"><code><i class="icon icon-minus"></i>global</code></td>
                        <td>Contains of the Metronic's Global Framework Files(css, javascript and images)</td>
                    </tr>
                    <tr>
                        <td style="padding-left: 25px"><code><i class="icon icon-minus"></i>sass</code></td>
                        <td>Contains of the Metronic Admin Theme and Global Framework CASS files. SASS support is available only for the admin theme</td>
                    </tr>
                    <tr>
                        <td style="padding-left: 50px"><code><i class="icon icon-minus"></i>admin</code></td>
                        <td>Contains of the admin theme layout and page SASS files</td>
                    </tr>
                    <tr>
                        <td style="padding-left: 50px"><code><i class="icon icon-minus"></i>global</code></td>
                        <td>Contains of the Global Framework SASS files</td>
                    </tr>
                    <tr>
                        <td style="padding-left: 50px"><code><i class="icon icon-minus"></i>admin</code></td>
                        <td>Contains of the admin html template files</td>
                    </tr>
                    <tr>
                        <td style="padding-left: 50px"><code><i class="icon icon-minus"></i>admin2</code></td>
                        <td>Contains of the admin 2 html template files</td>
                    </tr>
                    <tr>
                        <td style="padding-left: 50px"><code><i class="icon icon-minus"></i>admin3</code></td>
                        <td>Contains of the admin 3 html template files</td>
                    </tr>
                    </tbody>
                </table>
            </section>
    ...
    <div class="row">
        <div class="span12">
            <section id="extend">
                ...
                <p>
                    To overide the theme CSS styles you can use <code>../../assets/admin/layout/css/custom.css</code> for your own customization. This will make the future updates easier if you keep your own CSS code seperate.
                </p>
            </section>
        </div>
    </div>
        ...
        <div class="span12">
            <section id="plugins">
                ...
                <select id="pluginslist" onchange="ShowPlugin();">
                    ...
                    <option value="bootstrap_gtreetable">Bootstrap GTreeTable</option>
...
&lt;script src=&quot;../../assets/global/plugins/bootstrap-growl/jquery.bootstrap-growl.min.js&quot; type=&quot;text/javascript&quot;&gt;&lt;/script&gt;</pre>
                    <h4>Demo Page</h4>
                    <a href="ui_bootstrap_growl.html" target="_blank">ui_bootstrap_growl.html</a>
                    <h4>Official Documentation</h4>
...
&lt;script src=&quot;../../assets/global/plugins/autosize/autosize.min.js&quot; type=&quot;text/javascript&quot;&gt;&lt;/script&gt;</pre>
                    <h4>Demo Page</h4>
                    <a href="components_form_tools2.html" target="_blank">components_form_tools2.html</a>
                    <h4>Official Documentation</h4>
...
&lt;script src=&quot;../../assets/global/plugins/bootstrap-tabdrop/js/bootstrap-tabdrop.js&quot; type=&quot;text/javascript&quot;&gt;&lt;/script&gt;</pre>
                    <h4>Demo Page</h4>
                    <a href="ui_tabs_accordions_navs.html" target="_blank">ui_tabs_accordions_navs.html</a>
                    <h4>Official Documentation</h4>
...
&lt;script src=&quot;../../assets/global/plugins/jquery-minicolors/jquery.minicolors.min.js&quot; type=&quot;text/javascript&quot;&gt;&lt;/script&gt;</pre>
                ...
                <div id="bootstrap_gtreetable" class="pluginwrap">
                    <h3>Bootstrap GTreeTable</h3>
                    <p>
                        GTreeTable is extension of Tweeter Bootstrap 3 framework, which allows to use tree structure inside HTML table.
                    </p>
                    <h4>CSS Files</h4>
                            <pre class="prettyprint linenums">
&lt;link rel=&quot;stylesheet&quot; type=&quot;text/css&quot; href=&quot;../../assets/global/plugins/bootstrap-gtreetable/bootstrap-gtreetable.min.css&quot;&gt;</pre>
                    <h4>JavaScript Files</h4>
                            <pre class="prettyprint linenums">
&lt;script src=&quot;../../assets/global/plugins/bootstrap-gtreetable/bootstrap-gtreetable.min.js&quot; type=&quot;text/javascript&quot;&gt;&lt;/script&gt;</pre>
                    <h4>Demo Page</h4>
                    <a href="table_tree.html" target="_blank">table_tree.html</a>
                    <h4>Official Documentation</h4>
                    <a href="https://github.com/gilek/bootstrap-gtreetable" target="_blank">https://github.com/gilek/bootstrap-gtreetable</a>
                </div>
...
&lt;script src=&quot;../../assets/global/plugins/bootstrap-contextmenu/bootstrap-contextmenu.js&quot; type=&quot;text/javascript&quot;&gt;&lt;/script&gt;</pre>
                    <h4>Demo Page</h4>
                    <a href="components_context_menu.html" target="_blank">components_context_menu.html</a>
                    <h4>Official Documentation</h4>
...
&lt;script src=&quot;../../assets/global/plugins/bootstrap-confirmation/bootstrap-confirmation.min.js&quot; type=&quot;text/javascript&quot;&gt;&lt;/script&gt;</pre>
                    <h4>Demo Page</h4>
                    <a href="ui_confirmations.html" target="_blank">ui_confirmations.html</a>
                    <h4>Official Documentation</h4>
...
&lt;script src=&quot;../../assets/global/plugins/amcharts/amstockcharts/amstock.js&quot; type=&quot;text/javascript&quot;&gt;&lt;/script&gt;</pre>
                    <h4>Demo Page</h4>
                    <a href="charts_amcharts.html" target="_blank">charts_amcharts.html</a>
                    <h4>Official Documentation</h4>
...
&lt;script src=&quot;../../assets/global/plugins/icheck/icheck.min.js&quot; type=&quot;text/javascript&quot;&gt;&lt;/script&gt;</pre>
                    <h4>Demo Page</h4>
                    <a href="form_icheck.html" target="_blank">form_icheck.html</a>
                    <h4>Official Documentation</h4>
...
&lt;script src=&quot;../../assets/global/plugins/pace/pace.min.js&quot; type=&quot;text/javascript&quot;&gt;&lt;/script&gt;</pre>
                    <h4>Demo Page</h4>
                    <a href="ui_page_progress_style_1.html" target="_blank">ui_page_progress_style_1.html</a>
                    <h4>Official Documentation</h4>
...
&lt;script src=&quot;../../assets/global/plugins/bootstrap-summernote/summernote.min.js&quot; type=&quot;text/javascript&quot;&gt;&lt;/script&gt;</pre>
                    <h4>Demo Page</h4>
                    <a href="components_editors.html" target="_blank">components_editors.html</a>
                    <h4>Official Documentation</h4>
...
&lt;script src=&quot;../../assets/global/plugins/typeahead/typeahead.bundle.min.js&quot; type=&quot;text/javascript&quot;&gt;&lt;/script&gt;</pre>
                    <h4>Demo Page</h4>
                    <a href="components_form_tools.html" target="_blank">components_form_tools.html</a>
                    <h4>Official Documentation</h4>
...
&lt;script type=&quot;text/javascript&quot; src=&quot;../../assets/global/plugins/bootstrap-select/bootstrap-select.min.js&quot;&gt;&lt;/script&gt;</pre>
                    <h4>Demo Page</h4>
                    <a href="components_dropdowns.html" target="_blank">components_dropdowns.html</a>
                    <h4>Official Documentation</h4>
...
&lt;script src=&quot;../../assets/global/plugins/jquery-notific8/jquery.notific8.min.js&quot; type=&quot;text/javascript&quot; &gt;&lt;/script&gt;</pre>
                    <h4>Demo Page</h4>
                    <a href="ui_notific8.html" target="_blank">ui_notific8.html</a>
                    <h4>Official Documentation</h4>
...
&lt;script src=&quot;../../assets/global/plugins/jstree/dist/jstree.min.js&quot; type=&quot;text/javascript&quot; &gt;&lt;/script&gt;</pre>
                    <h4>Demo Page</h4>
                    <a href="ui_tree.html" target="_blank">ui_tree.html</a>
                    <h4>Official Documentation</h4>
...
&lt;script src=&quot;../../assets/global/plugins/bootstrap-sessiontimeout/jquery.sessionTimeout.min.js&quot; type=&quot;text/javascript&quot; &gt;&lt;/script&gt;</pre>
                    <h4>Demo Page</h4>
                    <a href="ui_session_timeout.html" target="_blank">ui_session_timeout.html</a>
                    <h4>Official Documentation</h4>
...
&lt;script src=&quot;../../assets/global/plugins/jquery-idle-timeout/jquery.idletimer.js&quot; type=&quot;text/javascript&quot; &gt;&lt;/script&gt;</pre>
                    <h4>Demo Page</h4>
                    <a href="ui_idle_timeout.html" target="_blank">ui_idle_timeout.html</a>
                    <h4>Official Documentation</h4>
...
No CSS available</pre>
                    <h4>JavaScript Files</h4>
                            <pre class="prettyprint linenums">
&lt;script src=&quot;../../assets/global/plugins/jquery-mixitup/jquery.mixitup.min.js&quot; type=&quot;text/javascript&quot;&gt;&lt;/script&gt;</pre>
                    <h4>Demo Page</h4>
                    <a href="page_portfolio.html" target="_blank">page_portfolio.html</a>
                    <h4>Official Documentation</h4>
...
&lt;script src=&quot;../../assets/global/plugins/bootstrap-datepaginator/bootstrap-datepaginator.min.js&quot; type=&quot;text/javascript&quot; &gt;&lt;/script&gt;
                    ...
                    <h4>Demo Page</h4>
                    <a href="ui_datepaginator.html" target="_blank">ui_datepaginator.html</a>
                    <h4>Official Documentation</h4>
...
&lt;script src=&quot;../../assets/global/plugins/bootbox/bootbox.min.js&quot; type=&quot;text/javascript&quot; &gt;&lt;/script&gt;</pre>
                    <h4>Demo Page</h4>
                    <a href="ui_bootbox.html" target="_blank">ui_bootbox.html</a>
                    <h4>Official Documentation</h4>
...
No CSS available</pre>
                    <h4>JavaScript Files</h4>
                            <pre class="prettyprint linenums">
&lt;script src=&quot;../../assets/global/plugins/fuelux/js/spinner.min.js&quot; type=&quot;text/javascript&quot;&gt;&lt;/script&gt;</pre>
                    <h4>Demo Page</h4>
                    <a href="components_form_tools.html" target="_blank">components_form_tools.html</a>
                    <h4>Official Documentation</h4>
                ...
                <div id="nouislider" class="pluginwrap ">
                    ...
                    <h4>CSS Files</h4>
                            <pre class="prettyprint linenums">
&lt;link href=&quot;../../assets/global/plugins/nouislider/jquery.nouislider.css&quot; rel=&quot;stylesheet&quot; type=&quot;text/css&quot; media=&quot;screen&quot;/&gt;</pre>
                    <h4>JavaScript Files</h4>
                            <pre class="prettyprint linenums">
&lt;script src=&quot;../../assets/global/plugins/nouislider/jquery.nouislider.js&quot; type=&quot;text/javascript&quot;&gt;&lt;/script&gt;</pre>
                    <h4>Demo Page</h4>
                    <a href="components_noui_sliders.html" target="_blank">components_noui_sliders.html</a>
                    <h4>Official Documentation</h4>
...
&lt;link href=&quot;../../assets/global/plugins/ion.rangeslider/css/ion.rangeSlider.Metronic.css&quot; rel=&quot;stylesheet&quot; type=&quot;text/css&quot;/&gt;</pre>
                    <h4>JavaScript Files</h4>
                            <pre class="prettyprint linenums">
&lt;script src=&quot;../../assets/global/plugins/ion.rangeslider/js/ion-rangeSlider/ion.rangeSlider.min.js&quot; type=&quot;text/javascript&quot;&gt;&lt;/script&gt;</pre>
                    <h4>Demo Page</h4>
                    <a href="components_ion_sliders.html" target="_blank">components_ion_sliders.html</a>
                    <h4>Official Documentation</h4>
...
&lt;script src=&quot;../../assets/global/plugins/bootstrap-toastr/toastr.min.js&quot; type=&quot;text/javascript&quot;&gt;&lt;/script&gt;</pre>
                    <h4>Demo Page</h4>
                    <a href="ui_toastr.html" target="_blank">ui_toastr.html</a>
                    <h4>Official Documentation</h4>
...
&lt;script src=&quot;../../assets/global/plugins/jquery-multi-select/js/jquery.multi-select.js&quot; type=&quot;text/javascript&quot;&gt;&lt;/script&gt;</pre>
  ...
  &lt;script src=&quot;../../assets/global/plugins/jcrop/js/jquery.Jcrop.min.js&quot; type=&quot;text/javascript&quot;&gt;&lt;/script&gt;</pre>
                    <h4>Demo Page</h4>
                    <a href="form_image_crop.html" target="_blank">form_image_crop.html</a>
                    <h4>Official Documentation</h4>
  ...
  &lt;!-- END X-EDITABLE PLUGIN--&gt;</pre>
                    <h4>Demo Page</h4>
                    <a href="form_editable.html" target="_blank">form_editable.html</a>
                    <h4>Official Documentation</h4>
...
&lt;script src=&quot;../../assets/global/plugins/bootstrap-modal/js/bootstrap-modal.js&quot; type=&quot;text/javascript&quot; &gt;&lt;/script&gt;</pre>
                    <h4>Demo Page</h4>
                    <a href="ui_modals.html" target="_blank">ui_modals.html</a>
                    <h4>Official Documentation</h4>
...
&lt;script type=&quot;text/javascript&quot; src=&quot;../../assets/global/plugins/jquery.bootpag.min.js&quot;&gt;&lt;/script&gt;</pre>
                    <h4>Demo Page</h4>
                    <a href="ui_general.html" target="_blank">ui_general.html</a>
                    <h4>Official Documentation</h4>
...
&lt;script src=&quot;../../assets/global/plugins/jquery-ui-touch-punch/jquery.ui.touch-punch.min.js&quot;&gt;&lt;/script&gt;</pre>
                    <h4>Demo Page</h4>
                    <a href="components_jqueryui_sliders.html" target="_blank">components_jqueryui_sliders.html</a>
                    <h4>Official Documentation</h4>
...
&lt;script src=&quot;../../assets/global/plugins/backstretch/jquery.backstretch.min.js&quot; type=&quot;text/javascript&quot;&gt;&lt;/script&gt;</pre>
                    <h4>Demo Page</h4>
                    <a href="page_coming_soon.html" target="_blank">page_coming_soon.html</a>
                    <h4>Official Documentation</h4>
...
&lt;script type=&quot;text/javascript&quot; src=&quot;../../assets/global/plugins/bootstrap-datetimepicker/js/bootstrap-datetimepicker.js&quot;&gt;&lt;/script&gt;</pre>
                    <h4>Demo Page</h4>
                    <a href="components_pickers.html" target="_blank">components_pickers.html</a>
                    <h4>Official Documentation</h4>
                ...
                <div id="select2" class="pluginwrap ">
                    ...
                    <h4>CSS Files</h4>
                            <pre class="prettyprint linenums">
&lt;link rel=&quot;stylesheet&quot; type=&quot;text/css&quot; href=&quot;../../assets/global/plugins/select2/select2.css&quot; /&gt;</pre>
                    <h4>JavaScript Files</h4>
                            <pre class="prettyprint linenums">
...
&lt;script src=&quot;../../assets/global/plugins/jquery-ui/jquery-ui-1.10.1.custom.min.js&quot;&gt;&lt;/script&gt;         </pre>
                    <h4>Demo Page</h4>
                    <a href="portlet_draggable.html" target="_blank">portlet_draggable.html</a>
                    <h4>Official Documentation</h4>
...
No CSS available</pre>
                    <h4>JavaScript Files</h4>
                            <pre class="prettyprint linenums">
&lt;!--[if lt IE 9]&gt;
&lt;script src=&quot;../../assets/global/plugins/js/respond.js&quot;&gt;&lt;/script&gt;  
&lt;![endif]--&gt; </pre>
                    <h4>Demo Page</h4>
                    <a href="index.html" target="_blank">index.html</a>
                    <h4>Official Documentation</h4>
...
No CSS available</pre>
                    <h4>JavaScript Files</h4>
                            <pre class="prettyprint linenums">
&lt;!--[if lt IE 9]&gt;
&lt;script src=&quot;../../assets/global/plugins/js/excanvas.js&quot;&gt;&lt;/script&gt; 
&lt;![endif]--&gt; </pre>
                    <h4>Demo Page</h4>
                    <a href="index.html" target="_blank">index.html</a>
                    <h4>Official Documentation</h4>
...
&lt;script type=&quot;text/javascript&quot; src=&quot;../../assets/global/plugins/clockface/js/clockface.js&quot;&gt;&lt;/script&gt;</pre>
                ...
                <div id="tagsinput" class="pluginwrap">
                    ...
                    <h4>CSS Files</h4>
                            <pre class="prettyprint linenums">
&lt;link rel=&quot;stylesheet&quot; type=&quot;text/css&quot; href=&quot;../../assets/global/plugins/jquery-tags-input/jquery.tagsinput.css&quot; /&gt;</pre>
                    <h4>JavaScript Files</h4>
                            <pre class="prettyprint linenums">
&lt;script type=&quot;text/javascript&quot; src=&quot;../../assets/global/plugins/jquery-tags-input/jquery.tagsinput.min.js&quot;&gt;&lt;/script&gt;</pre>
                    <h4>Demo Page</h4>
                    <a href="components_form_tools.html" target="_blank">components_form_tools.html</a>
                    <h4>Official Documentation</h4>
...
&lt;script type=&quot;text/javascript&quot; src=&quot;../../assets/global/plugins/ckeditor/ckeditor.js&quot;&gt;&lt;/script&gt;  </pre>
                ...
                <div id="datatables" class="pluginwrap">
                    ...
                    <h4>CSS Files</h4>
                            <pre class="prettyprint linenums">
&lt;link rel=&quot;stylesheet&quot; href=&quot;../../assets/global/plugins/datatables/plugins/bootstrap/dataTables.bootstrap.css&quot; /&gt;</pre>
                    <h4>JavaScript Files</h4>
                            <pre class="prettyprint linenums">
...
&lt;script type=&quot;text/javascript&quot; src=&quot;../../assets/global/plugins/datatables/plugins/bootstrap/dataTables.bootstrap.js&quot;&gt;&lt;/script&gt;</pre>
                    <h4>Demo Page</h4>
                    <a href="table_managed.html" target="_blank">table_managed.html</a>
                    <h4>Official Documentation</h4>
...
&lt;!-- END:File Upload Plugin JS files--&gt;</pre>
                    <h4>Demo Page</h4>
                    <a href="form_fileupload.html" target="_blank">form_fileupload.html</a>
                    <h4>Official Documentation</h4>
                ...
                <div id="fancybox" class="pluginwrap">
                    ...
                    <h4>CSS Files</h4>
                            <pre class="prettyprint linenums">
&lt;link href=&quot;../../assets/global/plugins/fancybox/source/jquery.fancybox.css&quot; rel=&quot;stylesheet&quot; /&gt;</pre>
                    <h4>JavaScript Files</h4>
                            <pre class="prettyprint linenums">
&lt;script src=&quot;../../assets/global/plugins/fancybox/source/jquery.fancybox.pack.js&quot;&gt;&lt;/script&gt;</pre>
                    <h4>Demo Page</h4>
                    <a href="gallery.html" target="_blank">gallery.html</a>
                    <h4>Official Documentation</h4>
...
&lt;script src=&quot;../../assets/global/plugins/flot/jquery.flot.resize.js&quot; type=&quot;text/javascript&quot;&gt;&lt;/script&gt;          
                    ...
                    <h4>Demo Page</h4>
                    <a href="charts.html" target="_blank">charts.html</a>
                    <h4>Official Documentation</h4>
...
&lt;script src=&quot;../../assets/global/plugins/js/demo.gmaps.js&quot;&gt;&lt;/script&gt;</pre>
                    <h4>Demo Page</h4>
                    <a href="maps_google.html" target="_blank">maps_google.html</a>
                    <h4>Official Documentation</h4>
...
&lt;script src=&quot;../../assets/global/plugins/fullcalendar/fullcalendar/fullcalendar.min.js&quot;&gt;&lt;/script&gt;  </pre>
                    <h4>Demo Page</h4>
                    <a href="calendar.html" target="_blank">calendar.html</a>
                    <h4>Official Documentation</h4>
                ...
                <div id="gritter" class="pluginwrap">
                    ...
                    <h4>CSS Files</h4>
                            <pre class="prettyprint linenums">
&lt;link rel=&quot;stylesheet&quot; type=&quot;text/css&quot; href=&quot;../../assets/global/plugins/gritter/css/jquery.gritter.css&quot; /&gt;</pre>
                    <h4>JavaScript Files</h4>
                            <pre class="prettyprint linenums">
&lt;script type=&quot;text/javascript&quot; src=&quot;../../assets/global/plugins/gritter/js/jquery.gritter.js&quot;&gt;&lt;/script&gt;</pre>
                    <h4>Demo Page</h4>
                    <a href="ui_general.html" target="_blank">ui_general.html</a>
                    <h4>Official Documentation</h4>
...
&lt;script src=&quot;../../assets/global/plugins/jqvmap/jqvmap/maps/jquery.vmap.world.js&quot; type=&quot;text/javascript&quot;&gt;&lt;/script&gt;</pre>
                    <h4>Demo Page</h4>
                    <a href="maps_vector.html" target="_blank">maps_vector.html</a>
                    <h4>Official Documentation</h4>
                ...
                <div id="uniform" class="pluginwrap">
                    ...
                    <h4>CSS Files</h4>
                            <pre class="prettyprint linenums">
&lt;link rel=&quot;stylesheet&quot; type=&quot;text/css&quot; href=&quot;../../assets/global/plugins/uniform/css/uniform.default.css&quot; /&gt;</pre>
                    <h4>JavaScript Files</h4>
                            <pre class="prettyprint linenums">
&lt;script type=&quot;text/javascript&quot; src=&quot;../../assets/global/plugins/uniform/jquery.uniform.min.js&quot;&gt;&lt;/script&gt;</pre>
                    <h4>Demo Page</h4>
                    <a href="form_controls.html" target="_blank">form_controls.html</a>
                    <h4>Official Documentation</h4>
...
&lt;script src=&quot;../../assets/global/plugins/dropzone/dropzone.js&quot;&gt;&lt;/script&gt;</pre>
                    <h4>Demo Page</h4>
                    <a href="form_dropzone.html" target="_blank">form_dropzone.html</a>
                    <h4>Official Documentation</h4>
...
&lt;script type=&quot;text/javascript&quot; src=&quot;../../assets/global/plugins/bootstrap-wizard/jquery.bootstrap.wizard.min.js&quot;&gt;&lt;/script&gt;</pre>
                    <h4>Demo Page</h4>
                    <a href="form_wizard.html" target="_blank">form_wizard.html</a>
                    <h4>Official Documentation</h4>
...
&lt;script src=&quot;../../assets/global/plugins/jquery-nestable/jquery.nestable.js&quot;&gt;&lt;/script&gt;</pre>
                    <h4>Demo Page</h4>
                    <a href="ui_nestable.html" target="_blank">ui_nestable.html</a>
                    <h4>Official Documentation</h4>
...
&lt;script type=&quot;text/javascript&quot; src=&quot;../../assets/global/plugins/jquery-validation/dist/jquery.validate.min.js&quot;&gt;&lt;/script&gt;</pre>
                    <h4>Demo Page</h4>
                    <a href="form_validation.html" target="_blank">form_validation.html</a>
                    <h4>Official Documentation</h4>
...
&lt;link href=&quot;../../assets/global/plugins/font-awesome/css/font-awesome.css&quot; rel=&quot;stylesheet&quot; /&gt;</pre>
                    <h4>Demo Page</h4>
                    <a href="ui_icons.html" target="_blank">ui_icons.html</a>
                    <h4>Official Documentation</h4>
        ...
        <div class="span12">
            <section id="references">
                ...
                <table class="table table-bordered table-striped" width="600">
                    ...
                    <tr>
                        <td>Twitter Bootstrap v3.3.4</td>
                    ...
                    <tr>
                        <td>Bootstrap Summernote v0.5.2</td>
                    ...
                    <tr>
                        <td>Twitter Typeahead v0.10.2</td>
                    ...
                    <tr>
                        <td>Bootstrap GTreeTable</td>
                        <td>GTreeTable is extension of Tweeter Bootstrap 3 framework, which allows to use tree structure inside HTML table.
                        </td>
                        <td><a href="https://github.com/gilek/bootstrap-gtreetable" target="_blank">https://github.com/gilek/bootstrap-gtreetable</a></td>
                    </tr>
        ...
        <div class="span12">
            <section id="log">
                ...
                <div class="changelog-list"  style="height: 500px; overflow-y:auto; border: 1px solid #ddd; background: #fff; padding: 20px;">
                    ...
                    <h4>Version 4.1.0 每 22 July 2015(Both LTR and RTL versions)</h4>
                    <ul>
                    ...
                    <h4>Version 4.0.2 每 22 June 2015(Both LTR and RTL versions)</h4>
                    <ul>
                    ...
                    <h4>Version 4.0 每 12 June 2015(Both LTR and RTL versions)</h4>
                    <ul>
                        <li>
                            NEW: Admin 6 Theme
                            <ul>
                    ...
                    <h4>Version 3.9.0 每 7 May 2015(Both LTR and RTL versions)</h4>
                    <ul>
                        <li>
                            NEW: Admin 5 Theme
                            <ul>
                    ...
                    <h4>Version 3.8.1 每 20 April 2015(Both LTR and RTL versions)</h4>
                    <ul>
                        <li>
                            FIX: Improvements & Minor Bug Fixes:<br>
                    ...
                    <h4>Version 3.8.0 每 20 April 2015(Both LTR and RTL versions)</h4>
                    <ul>
                        <li>
                        ...
                        <li>
                            ...
                            - Metronic.scrollTo() function issue in admin 3<br>
                    ...
                    <h4>Version 3.7.0 每 21 March 2015(Both LTR and RTL versions)</h4>
                    <ul>
                        <li>
                    ...
                    <h4>Version 3.6.3 每 10 March 2015(Both LTR and RTL versions)</h4>
                    <ul>
                        <li>
                    ...
                    <h4>Version 3.6.2 每 03 February 2015(Both LTR and RTL versions)</h4>
                    <ul>
                        <li>
                    ...
                    <h4>Version 3.6.1 每 24 December 2014(Both LTR and RTL versions)</h4>
                    <ul>
                        <li>
                    ...
                    <h4>Version 3.6 每 11 December 2014(Both LTR and RTL versions)</h4>
                    <ul>
                        <li>
                    ...
                    <h4>Version 3.5.2 每 8 December 2014(Both LTR and RTL versions)</h4>
                    <ul>
                        <li>
                    ...
                    <h4>Version 3.5.1 每 25 November 2014(Both LTR and RTL versions)</h4>
                    <ul>
                        <li>
                    ...
                    <h4>Version 3.5 每 11 November 2014(Both LTR and RTL versions)</h4>
                    <ul>
                        <li>
                    ...
                    <h4>Version 3.4 每 4 November 2014(Both LTR and RTL versions)</h4>
                    <ul>
                        <li>
                    ...
                    <h4>Version 3.3.1 每 14 October 2014(Both LTR and RTL versions)</h4>
                    <ul>
                        <li>
                    ...
                    <h4>Version 3.3.0 每 24 September 2014(Both LTR and RTL versions)</h4>
                    <ul>
                        <li>
                    ...
                    <h4>Version 3.2.0 每 03 September 2014(Both LTR and RTL versions)</h4>
                    <ul>
                        <li>
                    ...
                    <h4>Version 3.1.3 每 04 August 2014(Both LTR and RTL versions)</h4>
                    <ul>
                        <li>
                    ...
                    <h4>Version 3.1.2 每 17 July 2014(Both LTR and RTL versions)</h4>
                    <ul>
                        <li>
                    ...
                    <h4>Version 3.1.1 每 01 July 2014(Both LTR and RTL versions)</h4>
                    <ul>
                        <li>
                    ...
                    <h4>Version 3.1 每 09 June 2014(Both LTR and RTL versions)</h4>
                    <ul>
                        <li>
                    ...
                    <h4>Version 3.0.2 每 30 May 2014(Both LTR and RTL versions)</h4>
                    <ul>
                        <li>
                    ...
                    <h4>Version 3.0.1 每 10 May 2014(Both LTR and RTL versions)</h4>
                    <ul>
                        <li>
                    ...
                    <h4>Version 3.0 每 3 May 2014(Both LTR and RTL versions)</h4>
                    <ul>
                        <li>
                    ...
                    <h4>Version 2.0.2 每 20 February 2014(Both LTR and RTL versions)</h4>
                    <ul>
                        <li>
                    ...
                    <br>
                    <h4>Version 2.0.1 每 19 February 2014(Both LTR and RTL versions)</h4>
                    <ul>
                        <li>
                    ...
                    <br>
                    <h4>Version 2.0 每 12 February 2014(Both LTR and RTL versions)</h4>
                    <ul>
                        <li>
                    ...
                    <br>
                    <h4>Version 1.5.5 每 9 December 2013(Both LTR and RTL versions)</h4>
                    <ul>
                        <li>
                    ...
                    <br>
                    <br>
                    <h4>Version 1.5.4 每 21 November 2013(Both LTR and RTL versions)</h4>
                    <ul>
                        <li>
                    ...
                    <br>
                    <br>
                    <h4>Version 1.5.3 每 7 November 2013(Both LTR and RTL versions)</h4>
                    <ul>
                        <li>
                    ...
                    <br>
                    <h4>Version 1.5.2 每 21 October 2013(Both LTR and RTL versions)</h4>
                    <ul>
                        <li>
                    ...
                    <h4>Version 1.5.1 每 17 October 2013(Both LTR and RTL versions)</h4>
                    <ul>
                        <li>
                    ...
                    <br>
                    <h4>Version 1.5 每 7 October 2013(Both LTR and RTL versions)</h4>
                    <ul>
                        <li>
                    ...
                    <br>
                    <h4>Version 1.4 每 29 June 2013(Both LTR and RTL versions)</h4>
                    <ul>
                        <li>
                    ...
                    <br>
                    <h4>Version 1.3 每 14 June 2013(Both LTR and RTL versions)</h4>
                    <ul>
                        <li>
                    ...
                    <br>
                    <h4>Version 1.2.4 每 11 May 2013(Both LTR and RTL versions)</h4>
                    <ul>
                        <li>
                    ...
                    <br>
                    <h4>Version 1.2.3 每 3 May 2013</h4>
                    <ul>
                        <li>
                    ...
                    <br>
                    <h4>Version 1.2.2 每 22 April 2013</h4>
                    <ul>
                    ...
                    <br>
                    <h4>Version 1.2.1 每 13 April 2013</h4>
                    <ul>
                    ...
                    <br>
                    <h4>Version 1.2 每 10 April 2013</h4>
                    <ul>
                    ...
                    <br>
                    <h4>Version 1.1.2 每 17 March 2013</h4>
                    <ul>
                    ...
                    <br>
                    <h4>Version 1.1.1 每 10 March 2013</h4>
                    <ul>
                    ...
                    <br>
                    <h4>Version 1.1 每 26 February 2013</h4>
                    <ul>
                    ...
                    <br>
                    <h4>Version 1.0 每 13 February 2013</h4>
                    <ul>
