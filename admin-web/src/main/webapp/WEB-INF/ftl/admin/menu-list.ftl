...
<#include "../layout/common.ftl">
    ...
    <script type="text/javascript" src="${basePath}/assets/js/admin/menu.js?v=111212"></script>
</head>
    ...
    <div class="col-md-10">
        <div class="portlet light">
            <div class="portlet-title">
                ...
                <div class="actions">
                    <a class="btn btn-circle blue" id="addBtn" data-url="/admin/menu/getById.do?parentId=0">
...
<div class="modal fade" id="ajax-modal" data-width="600" data-height="400"></div>
