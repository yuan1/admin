...
(function ($) {
    ...
    if(!$('#jquery_tips_style').length){
        ...
        style+='.jq_tips_top{border-left.ftl:10px solid transparent;left.ftl:20px;bottom:0px;}';
        style+='.jq_tips_left{border-top:10px solid transparent;right:0px;top:18px;}';
        style+='.jq_tips_bottom{border-left.ftl:10px solid transparent;left.ftl:20px;top:0px;}';
        style+='.jq_tips_right{border-top:10px solid transparent;left.ftl:0px;top:18px;}';
