...
//import ImgmsgService;
//import TextmsgService;
...
// *
// * @author FH 313596790 作者单位： 联系方式： 创建时间：2014年7月10日
// * @version 1.0
// */
//@Controller
...
//                                    Data4Item d2 =
//                                            new Data4Item(msgpd.getString("TITLE2"), msgpd.getString("DESCRIPTION2"),
...
//                                    Data4Item d3 =
//                                            new Data4Item(msgpd.getString("TITLE3"), msgpd.getString("DESCRIPTION3"),
...
//                                    Data4Item d4 =
//                                            new Data4Item(msgpd.getString("TITLE4"), msgpd.getString("DESCRIPTION4"),
...
//                                    Data4Item d5 =
//                                            new Data4Item(msgpd.getString("TITLE5"), msgpd.getString("DESCRIPTION5"),
...
//                                    Data4Item d6 =
//                                            new Data4Item(msgpd.getString("TITLE6"), msgpd.getString("DESCRIPTION6"),
...
//                                    Data4Item d7 =
//                                            new Data4Item(msgpd.getString("TITLE7"), msgpd.getString("DESCRIPTION7"),
...
//                                    Data4Item d8 =
//                                            new Data4Item(msgpd.getString("TITLE8"), msgpd.getString("DESCRIPTION8"),
...
//
//    // ================================================获取关注列表==============================================================
//    public final static String gz_url =
...
//
//            /*
//             * PrintWriter pw; try { pw = new PrintWriter( new FileWriter( "e:/gz.txt" ) );
//             * pw.print(jsonObject.getString("total")); pw.close(); } catch (IOException e) { // TODO Auto-generated
