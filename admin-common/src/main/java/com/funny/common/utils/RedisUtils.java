...
public class RedisUtils {
    protected static Logger logger = LogManager.getLogger(RedisUtils.class);
    ...
    private static final RedisUtils redis = new RedisUtils();

    public static void init() {
        ResourceBundle bundle = ResourceBundle.getBundle("redis");
        if (bundle == null) {
            logger.error("Redis init fail : [redis.properties] is not found!");
        ...
        config.setTestOnBorrow("true".equals(bundle.getString("redis.testOnBorrow")));
        config.setTestOnReturn("true".equals(bundle.getString("redis.testOnReturn")));
        config.setTestWhileIdle("true".equals(bundle.getString("redis.testWhileIdle")));
    ...
    public class Objects {
        public String set(String key, Object value) {
            Jedis jedis = getJedis();
            String str = jedis.set(key.getBytes(), SerializeUtils.serialize(value));
            returnJedis(jedis);
            return str;
        }
